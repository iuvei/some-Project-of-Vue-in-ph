                        ...
                        <mt-tab-container v-model="active_index" swipeable >
                            <mt-tab-container-item id="1">
                                <div class="present_cont_item" v-if="concat_list" v-for="(item,index) in concat_list" :key="index" >
                                    <p><span>{{item.item}}</span> <strong>￥{{item.balance}}</strong></p>
                                    <h3>
                                    	<span>
                                            <i v-if="String(item.amount).indexOf('-') != -1" style="color:#4fb3ff;">{{item.amount}}</i>
                                            <i v-if="String(item.amount).indexOf('-') == -1" style="color:#fd0000;"> +{{item.amount}}</i>
                                        </span> 
                            ...
                            <mt-tab-container-item id="2" >
                                 <div class="present_cont_item" v-if="concat_list" v-for="(item,index) in concat_list" :key="index" >
                                    <p><span>{{item.item}}</span> <strong>￥{{item.balance}}</strong></p>
                                    <h3><span style="color:#fd0000">+{{item.amount}}</span> <strong>{{item.createDate}}</strong></h3>
                                </div>
                            ...
                            <mt-tab-container-item id="3" >
                               <div class="present_cont_item" v-if="concat_list" v-for="(item,index) in concat_list" :key="index" >
                                    ...
                                    <h3>
                                        ...
                                        <strong>{{item.createDate}}</strong></h3>
                                </div>
                            ...
                            <mt-tab-container-item id="4" >
                              <div class="present_cont_item" v-if="concat_list" v-for="(item,index) in concat_list" :key="index" >
                                    <p><span>{{item.item}}</span> <strong>￥{{item.balance}}</strong></p>
                                    <h3><span style="color:#4fb3ff">{{item.amount}}</span> <strong>{{item.createDate}}</strong></h3>
                                </div>
                             ...
                             <mt-tab-container-item id="5" >
                              <div class="present_cont_item" v-if="concat_list" v-for="(item,index) in concat_list" :key="index" >
                                ...
                                <div class="score-loading" v-if="isShow && active_index == '5'">
									<mt-spinner type="triple-bounce"></mt-spinner>
								</div>
                                <h6 class="no_data" v-if="is_show_nodata">已经全部加载完毕</h6>
                            </mt-tab-container-item>
                            ...
                            <mt-tab-container-item id="6" >
                              <div class="present_cont_item" v-if="concat_list" v-for="(item,index) in concat_list" :key="index" >
                                ...
                                <div class="score-loading" v-if="isShow && active_index == '6'">
									<mt-spinner type="triple-bounce"></mt-spinner>
								</div>
                                <h6 class="no_data" v-if="is_show_nodata">已经全部加载完毕</h6>
                            </mt-tab-container-item>
                             ...
                             <mt-tab-container-item id="7" >
                              <div class="present_cont_item" v-if="concat_list" v-for="(item,index) in concat_list" :key="index" >
                                ...
                                <div class="score-loading" v-if="isShow && active_index == '7'">
									<mt-spinner type="triple-bounce"></mt-spinner>
								</div>
                                <h6 class="no_data" v-if="is_show_nodata">已经全部加载完毕</h6>
                            </mt-tab-container-item>
...
<script type="text/ecmascript-6">
	...
	export default {
		...
		data() {
			return {
                switch_tab_text:['全部', '充值', '提款' , '购彩', '中奖', '佣金提成','其他'],
                active_index: '1',
                allLoaded:false,
                curr_page : 1,
                total_page : 1,
		...
		methods: {
            ...
            loadBottom(){
                ...
                this.curr_page++;
                requestOpt.reqTokenGet('accountDetail/type/' + this.active_index +'/page/' + this.curr_page +'/count/10',this.user.authToken,
                        (res)=>{
                            if(res.data.status){
