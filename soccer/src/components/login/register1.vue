...
<template>
  <div class="register">
		...
		<div class="register-input">
			...
			<login-input bgType="3" placeholder="邀请码（选填）" type="text" @inputVal="getAgentCode" ref="agentCode"></login-input>		
		</div>
  ...
  export default {
    ...
    mounted() {
				if(window.location.href.indexOf('code=')){					
					this.$refs.agentCode.setModel(window.location.href.split("code=")[1]);
				}
		},
    methods: {
    	register(){
