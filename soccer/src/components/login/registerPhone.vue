<template>
  <div class="register">
    	...
    	<router-link tag="p" to="/login" style="text-align: center;color: #9B9B9B;">已有账号，<span style="color: #24a8de;">点击登陆</span></router-link>
  </div>
