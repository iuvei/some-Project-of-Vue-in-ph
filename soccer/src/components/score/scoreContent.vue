		  	...
		  	<div class="content">
		  		...
		  		<div class="content-text">
		  			<div>
		  				...
		  				<p>{{info.leagueName}}[{{info.hOrder || 0}}]</p>
		  			</div>
		  			<div>		  				
		  				<p>{{info.leagueName}}[{{info.aOrder || 0}}]</p>
		...
		<div class="scoreBallContent-bottom" @touchstart="touchstart" ref="touch" @touchend ="touchend">			
			<mt-tab-container v-model="scoreIndex">
					...
					<mt-loadmore :top-method="loadTop" ref="loadmore">
						<div class="chat-warp">
							<div class="chat-warp-list" v-for="list in chatArr" :class="{isSelf: list.isSelf}">
								...
								<div>
									<p class="chat-title"><span>{{list.userName}}</span>{{list.createDate | formData}}</p>
				...
				<mt-tab-container-item id="2">
					<div class="main-item-warp"  @click="bet($event)">
...
<script>
	...
	export default {
		...
		methods: {
			...
			fnBind(e){//不阻止默认行为，UC浏览器下会不触发动画，不取消默认，后面就不能滚了啊
