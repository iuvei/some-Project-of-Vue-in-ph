  ...
  <div class="betting-content">
    <div class="betting-head">
      <ul>
        ...
        <li class="betting-head2 title" @click="hideDailog">
          <span>我的追号</span>
      ...
      <div v-show="isShow" class="header-is-active" @click="hideDailog">
        ...
        <div class="header-modal-content">
          <ul>
            ...
            <router-link tag="div" class="tab-item" to="/tolottery">
              <li>待开奖</li>
            </router-link>
            <router-link tag="div" class="tab-item" to="/haswinning">
              <li>已中奖</li>
            </router-link>
            <router-link tag="div" class="tab-item" to="/chasenumber">
              <li class="red">我的追号</li>
            </router-link>
            <router-link tag="div" class="tab-item" to="/cancelorder">
              <li>我的撤单</li>
            </router-link>
            <router-link tag="div" class="tab-item" to="/notwinning">
              <li>未中奖</li>
            </router-link>
            <router-link tag="div" class="tab-item" to="/tovoid">
              <li>作废</li>
            </router-link>
          </ul>
        </div>
    ...
    <!--我的追号-->
    <div class="betting">
      <router-link tag="div" class="tab-item" to="/chase">
        <dl class="betting-list">
          <dt class="betting-list-img"><img src="../../images/sanfen@2x.png" alt=""></dt>
          <dd class="betting-list-title">
            <dl>
              <dt><span>三分时时彩</span><span class="zhui">追号</span></dt>
              <dd><span>2017-05-05</span><span>17:50:25</span></dd>
            </dl>
          </dd>
          <dd class="betting-list-state">
            <dl>
              <dt>18.0元</dt>
              <dd class="blue">1/0/2</dd>
              <dd class="hong">进行中</dd>
            </dl>
          </dd>
        </dl>
      </router-link>
...
<style scoped lang="stylus" rel="stylesheet/stylus">
  ...
  .betting dl.betting-list .betting-list-title dl dt span{
    font-size 0.24rem
    color #323232
    float left
    line-height 0.62rem
  ...
  .betting dl.betting-list .betting-list-title dl dt span.zhui{
    font-size 0.14rem
    color #9e9e9e
    float left
    line-height 0.62rem
  ...
  .betting dl.betting-list .betting-list-state dl dd.hong{
    width 2.9rem
    display block
    height 0.4rem
    float right
