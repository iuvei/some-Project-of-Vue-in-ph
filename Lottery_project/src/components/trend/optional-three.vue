  ...
  <div class="playing-content">
    <div class="playing-head">
      <ul>
        ...
        <li class="playing-head2" @click="hideDailog">
          ...
          <span class="playing-span2">任选三-直选复式</span>
    ...
    <transition name="fade">
      ...
      <div v-show="isShow" class="header-is-active" @click="hideDailog">
        <div class="optional-three-modal">
          <dl class="optional-three-modal1">
            <dt>任选三</dt>
            <dd class="w620"></dd>
          </dl>
          <ul>
            ...
            <router-link tag="div" to="/three">
              <li>三星</li>
            </router-link>
            <router-link tag="div" to="/position">
              <li>定位胆</li>
            </router-link>
            <router-link tag="div" to="/size">
              <li>大小单双</li>
            </router-link>
            <router-link tag="div" to="/optional2">
              <li>任选二</li>
            </router-link>
            <router-link tag="div" to="/optional3">
              <li class="red">任选三</li>
            </router-link>
            <router-link tag="div" to="/optional4">
              <li>任选四</li>
            </router-link>
          </ul>
          <dl>
    ...
    <div class="playing">
      ...
      <div class="playing-fixed">
        <div class="playing-fixed1">
          ...
          <dl class="fixed-t">
            <dt><span>02</span><span>05</span><span>12</span><span>32</span><span>11</span></dt>
            <dd>00：21：55</dd>
          </dl>
        </div>
    ...
    <div class="playing-account">
      <dl>
        <dt>
          <div class="playing-account-left">
            <img src="../../images/del@3x.png" alt="">
            <span>清空</span>
          </div>
          <div class="playing-account-right">
            <span>5</span>注<span>10</span>元
          </div>
        </dt>
        <dd>
...
<style scoped lang="stylus" rel="stylesheet/stylus">
  ...
  .optional-three-modal dl.optional-three-modal1{
    position relative
    top: 0.3rem
    display block
  ...
  .optional-three-modal  dl dd.w620{
    width 6.2rem
  }
  .optional-three-modal  dl dd.w600{
    width 6rem
  }
  .optional-three-modal ul{
    width 7.5rem
    height auto
    display block
  }
  .optional-three-modal ul li{
    width 2.3rem
    height 0.6rem
    float left
    display block
  ...
  .optional-three-modal ul li.red{
    background  #ffffff;
    color #ff3a3b;
  ...
  .playing-fixed1 dl dt{
    float left
    text-align left
  }
  .playing-fixed1 dl dd{
    float right
    text-align right
  }
