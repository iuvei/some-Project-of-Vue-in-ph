  ...
  <div style="height:100%;">
    ...
    <div class="digit" >
      ...
      <ul class="wei_ul">
        ...
        <li class="six-li" @click="open_btn(6)">红六</li>
        <li class="seven-li" @click="open_btn(7)">蓝一</li>
      </ul>>
                ...
                <div id="wanwei" v-show="digit_active==1" class="wanwei">
                    <div class="periods">
                        ...
                        <ul >
                            ...
                            <li v-for="n in 33 " > {{ n }}</li>
                        </ul>
                        </div>
                        <div class="wan_list" ref="wan_list">
                            <!-- 左边表格期数 -->
                            <div class="wan_table_2" style="flex:2.07;  -webkit-flex  : 2.07;">
