  ...
  <div class="playing-content">
    <div class="playing-head">
      <ul>
        ...
        <li class="playing-head2" @click="hideDailog">
          ...
          <span class="playing-span2">任选四-直选复式</span>
    ...
    <transition name="fade">
      ...
      <div v-show="isShow" class="header-is-active" @click="hideDailog">
        <div class="optional-four-modal">
          <dl class="optional-four-modal1">
            <dt>任选四</dt>
            <dd class="w620"></dd>
          </dl>
          <ul>
...
<style scoped lang="stylus" rel="stylesheet/stylus">
  ...
  .optional-four-modal dl.optional-four-modal1{
    position relative
    top: 0.3rem
    display block
  ...
  .optional-four-modal  dl dd.w620{
    width 6.2rem
  }
  .optional-four-modal  dl dd.w600{
    width 6rem
  }
  .optional-four-modal ul{
    width 7.5rem
    height auto
    display block
  }
  .optional-four-modal ul li{
    width 2.3rem
    height 0.6rem
    float left
    display block
