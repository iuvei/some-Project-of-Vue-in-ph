  ...
  <div class="playing-content">
    <div class="playing-head">
      <ul>
        ...
        <li class="playing-head2" @click="hideDailog">
          ...
          <span class="playing-span2">任选二-直选复式</span>
    ...
    <transition name="fade">
      ...
      <div v-show="isShow" class="header-is-active" @click="hideDailog">
        <div class="optional-two-modal">
          <dl class="optional-two-modal1">
            <dt>任选二</dt>
            <dd class="w620"></dd>
          </dl>
          <ul>
...
<style scoped lang="stylus" rel="stylesheet/stylus">
  ...
  .optional-two-modal dl.optional-two-modal1{
    position relative
    top: 0.3rem
    display block
  ...
  .optional-two-modal  dl dd.w620{
    width 6.2rem
  }
  .optional-two-modal  dl dd.w600{
    width 6rem
  }
  .optional-two-modal ul{
    width 7.5rem
    height auto
    display block
  }
  .optional-two-modal ul li{
    width 2.3rem
    height 0.6rem
    float left
    display block
