  ...
  <div >
    ...
    <div class="digit">
      <ul class="wei_ul">
        ...
        <li class="one-li" @click="open_btn(1)">百位</li>
        <!-- <router-link >万位</router-link> -->
        <li class="two-li" @click="open_btn(2)">十位</li>
        <li class="three-li" @click="open_btn(3)">个位</li>
      </ul>
    </div>
    <!-- <div class="big_box"> -->
            ...
            <div>
                ...
                <div v-show="digit_active==0" class="start-contents">
                    ...
                    <table>
                        ...
                        <td class="title-width" style="flex:2;  -webkit-flex  : 2;" v-for="(item,index) in items.titles" v-if="index == 1">{{item}}</td>
                        <td class="title-width" style="flex:1;  -webkit-flex  : 1;" v-for="(item,index) in items.titles" v-if="index == 2">{{item}}</td>
                        <td class="title-width" style="flex:1;  -webkit-flex  : 1;" v-for="(item,index) in items.titles" v-if="index == 3">{{item}}</td>
                        <td class="title-width" style="flex:2;  -webkit-flex  : 2;" v-for="(item,index) in items.titles" v-if="index == 4">{{item}}</td>
                        <td v-for="(item,index) in items.titles" v-if="index == 5" style="flex:1;  -webkit-flex  : 1;">
                        ...
                        <td v-for="(item,index) in items.titles" v-if="index == 6" style="flex:1;  -webkit-flex  : 1;">
                            {{item}}
                        </td>
                        </tr>
                    </table>
                    ...
                    <table>
                        ...
                        <td class="title-colors-red title-width" style="flex:2;  -webkit-flex  : 2;">
                            <span v-for="(item,index) in items.res">{{item}}</span>
                        </td>
                        <td style="flex:1;  -webkit-flex  : 1;">{{items.sum}}</td>
                        <!-- <td>{{indexs}}</td> -->
                        <td style="flex:1;  -webkit-flex  : 1;">{{items.span}}</td>
                        <td class="title-width" style="flex:2;  -webkit-flex  : 2;">{{items.kuai3_form}}</td>
                        <!-- <td>{{items.dxds}}</td> -->
                        <td v-for="(item,index) in items.bit_modes" v-if="index == 0" style="flex:1;  -webkit-flex  : 1;">{{item}}</td>
                        <td v-for="(item,index) in items.bit_modes" v-if="index == 1" style="flex:1;  -webkit-flex  : 1;">{{item}}</td>
                        <td v-for="(item,index) in items.bit_modes" v-if="index == 2" style="flex:1;  -webkit-flex  : 1;">{{item}}</td>
                ...
                <div id="wanwei" v-show="digit_active==1" class="wanwei">
                    ...
                    <table class="wan_table">
                        <tr style="display:flex;display: -webkit-flex;">
                        <td class="periods1" style="flex : 2.05;  -webkit-flex  : 2.05;">期数</td>
                        <td v-for="(items,indexs) in wan_data_list[0]" style="flex : 1;  -webkit-flex  : 1;">{{ indexs  }}</td>
                        </tr>
                    </table>
