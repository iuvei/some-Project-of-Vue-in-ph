<template>
  <div class="r-password-content">
    <back title="修改交易密码" go-back="true"></back>
  ...
  export default {
    ...
    methods: {
      updatePW() {
        ...
        requestOpt.reqPutAuthUser('transaction_password', sessionStorage.getItem('token'), {
          old_pass: this.old,
...
<style scoped lang="stylus" rel="stylesheet/stylus">
  ...
  .r-password dl  dd.verification1{
    width 5rem
    height 0.68rem
    display inline-block
    color #000000
  ...
  .r-password dl.verification3{
    margin-top 0.4rem
  }
  .r-password dl.verification3 input{
    width 7.1rem
    height 0.88rem
    color #ffffff
    background #ff3a3a
