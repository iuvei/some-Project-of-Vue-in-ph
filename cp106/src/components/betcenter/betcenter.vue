            ...
            <div class="betcenter-select-number">
              ...
              <div class="betcenter-wediget">
                ...
                <div class="betcenter-action" >
                  <div class="betcenter_action_btns" v-loading="loading_bet" element-loading-spinner=" "  element-loading-background="transparent" >
...
.betcenter {
 ...
 .betcenter_action_btns .el-loading-mask{
     border-radius:50%;
 }
