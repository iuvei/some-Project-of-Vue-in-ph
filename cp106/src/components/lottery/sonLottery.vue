          ...
          <div class="lottery_cont" v-loading="loading2" style="min-height:200px;">
              ...
              <table>
                  ...
                  <tbody>
                      ...
                      <tr class="lhc_tr_data" v-for="(items, indexs) in cp_data_list" :key="indexs" v-if="($route.params.lot_type_id  == 23 )">
                          <td>{{ cp_title }}</td>
                          <td>第{{items.issue_number}}期</td>
                          <td>
                              <p>
                                <span style="margin-right:5px;" class="bo_se_span" v-for="(item,index) in items.res"  :key="index * Math.random()">
                                  {{item}}
                                </span>
                              </p>
                              <p>
                                  <i v-if="items.res" style="margin-right:5px;"  v-for="(item,index) in items.res"  :key="index * Math.random()"> {{ lhc_color_formate(item).text }} </i>
                              </p>
                      ...
                      <tr class="lhc_tr_data" v-for="(items, indexs) in cp_data_list" :key="indexs" v-if="($route.params.lot_type_id  == 24 )">
                          <td>{{ cp_title }}</td>
                          <td>第{{items.issue_number}}期</td>
                          <td>
                              <p>
...
.lottery_cont>table>tbody>tr.lhc_tr_data td:nth-child(3) p:nth-child(1){
    margin-top:12px;
}
.lottery_cont>table>tbody>tr.lhc_tr_data td:nth-child(3) p:nth-child(2) i{
