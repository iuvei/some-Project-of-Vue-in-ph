<template>
    <div class="PL3">
        ...
        <div class="PL3_wrap PL3_wrap_2" v-show="is_show_data_1">
            <div class="PL3_cont" >
                <div class="PL3_cont_item">
                     <div class="PL3_cont_head_1" v-if="start_list_box.length > 1">
                        <!-- <h4>期数</h4>
                        <h5>开奖号码</h5>
                ...
                <div class="PL3_cont_item" v-for="(arr_items,arr_indexs) in arr_data_list.stat" :key="arr_indexs">
                    <div class="PL3_cont_head_2">
                    ...
                    <div class="PL3_cont_data_2" :class="'canvas_wrap_' + (arr_indexs-1)">
                        <table>
                            <tbody>
            ...
            <div class="PL3_footer">
                <div class="PL3_footer_1">
                    <p>总共出现</p>
                    <p>最大连出</p>
                    <p>最大遗漏</p>
                    <p>平均遗漏</p>
                ...
                <div class="PL3_footer_2" v-for="(items,indexs) in arr_data_list.stat" :key="indexs" >
                    <!-- <table>
                        <tbody>
...
<style >
  ...
  .PL3_wrap .check_box .el-checkbox__input.is-checked+.el-checkbox__label{
         color : #555555;
     }


   .PL3_wrap .check_box   .el-checkbox__input.is-checked{
         background: none;
     }
   .PL3_wrap .check_box  .el-checkbox__label{
        padding-left:5px;
    }

    .PL3_wrap .check_box  .el-checkbox__input.is-checked .el-checkbox__inner, .PL3_wrap .el-checkbox__input.is-indeterminate .el-checkbox__inner{
         background-color: #fff;
         border-color: #555555;
     }

     .PL3_wrap .el-checkbox__input.is-focus .el-checkbox__inner{
         border-color :  #555;
     }

    .PL3_wrap .el-checkbox__input{
        margin-top:-0.5px;
    }

    .PL3_wrap .el-checkbox{
        border-color: #666666;
     }

    .PL3_wrap .el-checkbox__inner{
         border : 1px solid #666666;
     }

    .PL3_wrap .el-checkbox__input.is-checked .el-checkbox__inner span::after{
        
     }

    .PL3_wrap .el-checkbox__inner::after{
        top:0px;
        left:3px;
    ...
    .PL3_cont_data_1 table{
        width:100%;
        border-collapse: collapse;
    }

    .PL3_cont_data_1 table tbody{
        width:100%;
    }

    .PL3_cont_data_1 table tr{
        width:100%;
        height:30px;
        display : flex;
    }
    .PL3_cont_data_1 table tr td{
        height:30px; 
        line-height:30px;
        flex:1;
        font-size:11px;
    ...
    .PL3_cont_data_1 table tr td:nth-child(2){
        color:red;
    }

     .PL3_cont_data_1 table tr td:nth-child(1), .PL3_cont_data_1 table tr td:nth-child(2){
          flex:2;
     }
     .PL3_cont_data_1 table tr td:nth-child(8), .PL3_cont_data_1 table tr td:nth-child(9){
         flex:1;
         font-size:11px;
     }
 ...
 .PL3_cont>div:nth-child(1){
        flex: 1.5;
    }

    .PL3_cont>div:last-child{
        border:none;
    }

    .PL3_cont_item .PL3_cont_head_1{
        height: 60px;
        line-height: 60px;
        background: #e8eced;
    ...
    .PL3_cont_item .PL3_cont_head_1>h4{
        flex: 2;
        text-align: center;
        letter-spacing: 2px;
        font-size: 12px;
    ...
    .PL3_cont_item .PL3_cont_head_1>h5{
         flex: 2;
         text-align:center;
         letter-spacing: 1px;
         font-size: 11.5px;
    ...
    .PL3_cont_item .PL3_cont_head_1>h6{
        flex: 1;
        font-size:11.5px;
        text-align: center;
    }

    .PL3_cont_item .PL3_cont_head_1 > h6:nth-child(8),.PL3_cont_item .PL3_cont_head_1 > h6:nth-child(9){
        flex:1;
    }
    ...
    .PL3_cont_head_2>div>span{
        flex: 1;
        line-height: 30px;
        color:#515253;
        text-align: center;
    }
    .PL3_cont_head_2>div>span+span{
    ...
    .PL3_cont_data_1>ul:nth-child(2)>li{
        color : #ff0000;
    }
    .PL3_cont_data_1>ul>li, .PL3_cont_data_1>ol>li{
        height: 30px;
        line-height: 30px;
        text-align: center;
        font-size: 12px;
    ...
    .PL3_cont_data_1>ul>li:nth-child(odd), .PL3_cont_data_1>ol>li:nth-child(odd), .PL3_cont_data_1 table tr:nth-child(odd){
        background:#f3f2f2;;
    }
    .PL3_cont_data_1>ul>li:nth-child(even), .PL3_cont_data_1>ol>li:nth-child(even) , .PL3_cont_data_1 table tr:nth-child(even){
        background:#f3fdfb;
    }
   ...
   .PL3_cont_data_2{
    ...
    .PL3_cont_data_2 table{
        width:100%;
    }

   .PL3_cont_data_2 table tr{
       display: flex;
       height:30px;
       line-height:30px;
   }

   .PL3_cont_data_2 table tr:nth-child(odd){
       background:#f3f2f2;
   }
   .PL3_cont_data_2 table tr:nth-child(even){
       background:#f3fdfb;
   }

    .PL3_cont_data_2 table tr td{
        flex: 1;
         font-size: 12px;
         color: #aaa;
         position: relative;
    ...
    .PL3_cont_data_2 table tr td+td{
        border-left: 0.5px solid #fff;
    }

    .PL3_cont_data_2 table tr td i{
    ...
    .PL3_footer>div:nth-child(1){
        flex:1.5;
    }

    .PL3_footer>div:nth-child(1)>p{
        height:30px;
        line-height:30px;
        text-align:center;
    }
    .PL3_footer>div:nth-child(1)>p:nth-child(odd), .PL3_footer .PL3_footer_2 table tbody tr:nth-child(odd){
        background : #00ffff;
    }
    .PL3_footer>div:nth-child(1)>p:nth-child(even), .PL3_footer .PL3_footer_2 table tbody tr:nth-child(even){
         background : #f3f2f2;
    }
    ...
    .PL3_footer_2>ul>li:nth-child(odd){
        background : #00ffff;
    }
    .PL3_footer_2>ul>li:nth-child(even){
        background : #f3f2f2;
    }
