            ...
            <div class="check_box">
             ...
             <div class="start_tab" style="border-top:1.5px solid #fff;">
                <ul>
                    ...
                    <li @click="tab_start(1)" :class="{'active' : is_start_tab[1] == true}">红一</li>
                    <li @click="tab_start(2)" :class="{'active' : is_start_tab[2] == true}">红二</li>
                    <li @click="tab_start(3)" :class="{'active' : is_start_tab[3] == true}">红三</li>
                    <li @click="tab_start(4)" :class="{'active' : is_start_tab[4] == true}">红四</li>
                    <li @click="tab_start(5)" :class="{'active' : is_start_tab[5] == true}">红五</li>
                    <li @click="tab_start(6)" :class="{'active' : is_start_tab[6] == true}">蓝一</li>
                    <li @click="tab_start(7)" :class="{'active' : is_start_tab[7] == true}">蓝二</li>
                </ul>
            </div>
        </div>
       
        <div class="SSQ_wrap SSQ_wrap_2" v-show="is_show_data_1">
            <div class="SSQ_cont" >
                <div class="SSQ_cont_item" v-show="is_start_tab[0]">
                     <div class="SSQ_cont_head_1" v-if="start_list_box.length > 1">
                     ...
                     <div class="SSQ_cont_data_1">
                         <table>
                             <tbody>
                                 <tr v-for="(items,indexs) in start_list_box">
                                     <td>{{ items.issue_number }}</td>
                                     <td >
                                          <span v-for="(item,index) in items.res" v-if="index <= 4" style="color:#ff0000">  {{ item }} </span>
                ...
                <div class="SSQ_cont_item" v-show="is_start_tab[arr_indexs]" v-for="(arr_items,arr_indexs) in arr_data_list.stat" :key="arr_indexs">
                    <div class="SSQ_cont_head_2">
                    ...
                    <div class="SSQ_cont_data_2" :class="'canvas_wrap_' + (arr_indexs-1)">
                        <table>
                            <tbody>
                    ...
                    <div class="SSQ_footer" v-show=" is_start_tab[arr_indexs]">
                        <div class="SSQ_footer_1">
                            <p>总共出现</p>
                            <p>最大连出</p>
                            <p>最大遗漏</p>
                            <p>平均遗漏</p>
                        ...
                        <div class="SSQ_footer_2" v-for="(items,indexs) in arr_data_list.stat" :key="indexs"   v-show=" is_start_tab[indexs]">
    ...
    export default{
        ...
        data(){
            return{
                ...
                hide_func_bool:true,
                select_wei:['红一', '红二' , '红三' , '红四' , '红五', '红六' , '蓝一'],
        ...
        methods:{    
            get_data(list_length){
                ...
                requestOpt.reqnoGetpara(
                    ...
                    //  console.log(this.start_list_box);
                     this.list_length = this.start_list_box.length;
            ...
            draw_yilou(className, id){
                ...
                // this.list_length= this.list_length < 30 ? 25 : this.list_length;
...
<style >
  ...
  .SSQ_wrap .check_box .el-checkbox__input.is-checked+.el-checkbox__label{
         color : #555555;
     }


   .SSQ_wrap .check_box   .el-checkbox__input.is-checked{
         background: none;
     }
   .SSQ_wrap .check_box  .el-checkbox__label{
        padding-left:5px;
    }

    .SSQ_wrap .check_box  .el-checkbox__input.is-checked .el-checkbox__inner, .SSQ_wrap .el-checkbox__input.is-indeterminate .el-checkbox__inner{
         background-color: #fff;
         border-color: #555555;
     }

     .SSQ_wrap .el-checkbox__input.is-focus .el-checkbox__inner{
         border-color :  #555;
     }

    .SSQ_wrap .el-checkbox__input{
        margin-top:-0.5px;
    }

    .SSQ_wrap .el-checkbox{
        border-color: #666666;
     }

    .SSQ_wrap .el-checkbox__inner{
         border : 1px solid #666666;
     }

    .SSQ_wrap .el-checkbox__input.is-checked .el-checkbox__inner span::after{
        
     }

    .SSQ_wrap .el-checkbox__inner::after{
        top:0px;
        left:3px;
    ...
    .SSQ_cont_data_1 table{
        width:100%;
        border-collapse: collapse;
    }

    .SSQ_cont_data_1 table tbody{
        width:100%;
    }

    .SSQ_cont_data_1 table tr{
        width:100%;
        height:30px;
        line-height:30px;
    ...
    .SSQ_cont_data_1 table tr td:nth-child(2){
        color:red;
    }

     .SSQ_cont_data_1 table tr td:nth-child(1), .SSQ_cont_data_1 table tr td:nth-child(2){
          flex:2;
     }
     .SSQ_cont_data_1 table tr td:nth-child(8), .SSQ_cont_data_1 table tr td:nth-child(9){
         flex:1;
         font-size:11px;
     }
   ...
   .SSQ_cont>div:nth-child(1){
        flex: 1.5;
    }

    .SSQ_cont>div:last-child{
        border:none;
    }

    .SSQ_cont_item .SSQ_cont_head_1{
        height: 60px;
        line-height: 60px;
        background: #e8eced;
    ...
    .SSQ_cont_item .SSQ_cont_head_1>h4{
        flex: 2;
        text-align: center;
        letter-spacing: 2px;
        font-size: 12px;
    ...
    .SSQ_cont_item .SSQ_cont_head_1>h5{
         flex: 2;
         text-align:center;
         letter-spacing: 1px;
         font-size: 11.5px;
    ...
    .SSQ_cont_item .SSQ_cont_head_1>h6{
        flex: 1;
        font-size:11.5px;
        text-align: center;
    }

    .SSQ_cont_item .SSQ_cont_head_1 > h6:nth-child(8),.SSQ_cont_item .SSQ_cont_head_1 > h6:nth-child(9){
        flex:1;
    }
    ...
    .SSQ_cont_head_2>div>span{
        flex: 1;
        line-height: 30px;
        color:#515253;
        text-align: center;
    }
    .SSQ_cont_head_2>div>span+span{
    ...
    .SSQ_cont_data_1>ul:nth-child(2)>li{
        /* color : #ff0000; */
    }
    .SSQ_cont_data_1>ul>li, .SSQ_cont_data_1>ol>li{
        height: 30px;
        line-height: 30px;
        text-align: center;
        font-size: 12px;
    ...
    .SSQ_cont_data_1>ul>li:nth-child(odd), .SSQ_cont_data_1>ol>li:nth-child(odd), .SSQ_cont_data_1 table tr:nth-child(odd){
        background:#f3f2f2;;
    }
    .SSQ_cont_data_1>ul>li:nth-child(even), .SSQ_cont_data_1>ol>li:nth-child(even) , .SSQ_cont_data_1 table tr:nth-child(even){
        background:#f3fdfb;
    }
   ...
   .SSQ_cont_data_2{
    ...
    .SSQ_cont_data_2 table{
        width:100.15%;
    }

   .SSQ_cont_data_2 table tr{
       display: flex;
       height:30px;
       line-height:30px;
   }

   .SSQ_cont_data_2 table tr:nth-child(odd){
       background:#f3f2f2;
   }
   .SSQ_cont_data_2 table tr:nth-child(even){
       background:#f3fdfb;
   }

    .SSQ_cont_data_2 table tr td{
        flex: 1;
         font-size: 12px;
         color: #aaa;
         position: relative;
    ...
    .SSQ_cont_data_2 table tr td+td{
        border-left: 0.5px solid #fff;
    }

    .SSQ_cont_data_2 table tr td i{
    ...
    .SSQ_footer>div:nth-child(1){
        flex:1.98;
    }

    .SSQ_footer>div:nth-child(1)>p{
        height:30px;
        line-height:30px;
        text-align:center;
    }
    .SSQ_footer>div:nth-child(1)>p:nth-child(odd), .SSQ_footer .SSQ_footer_2 table tbody tr:nth-child(odd){
        background : #00ffff;
    }
    .SSQ_footer>div:nth-child(1)>p:nth-child(even), .SSQ_footer .SSQ_footer_2 table tbody tr:nth-child(even){
         background : #f3f2f2;
    }
    ...
    .SSQ_footer_2>ul>li:nth-child(odd){
        background : #00ffff;
    }
    .SSQ_footer_2>ul>li:nth-child(even){
        background : #f3f2f2;
    }
