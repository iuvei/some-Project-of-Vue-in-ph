<template>
    <div class="SD11X5">
        <div class="SD11X5_wrap SD11X5_wrap_1">
            <h3>历史号码走势</h3>
        ...
        <div class="SD11X5_wrap SD11X5_wrap_2" v-show="is_show_data_1">
            <div class="SD11X5_cont" >
                <div class="SD11X5_cont_item">
                     <div class="SD11X5_cont_head_1" v-if="start_list_box.length > 1">
                        <!-- <h4>期数</h4>
                        <h5>开奖号码</h5>
                ...
                <div class="SD11X5_cont_item" v-for="(arr_items,arr_indexs) in arr_data_list.stat" :key="arr_indexs">
                    <div class="SD11X5_cont_head_2">
                    ...
                    <div class="SD11X5_cont_data_2" :class="'canvas_wrap_' + (arr_indexs-1)">
                        <table>
                            <tbody>
            ...
            <div class="SD11X5_footer">
                <div class="SD11X5_footer_1">
                    <p>总共出现</p>
                    <p>最大连出</p>
                    <p>最大遗漏</p>
                    <p>平均遗漏</p>
                ...
                <div class="SD11X5_footer_2" v-for="(items,indexs) in arr_data_list.stat" :key="indexs" >
                    <!-- <table>
                        <tbody>
...
<style >
  ...
  .SD11X5_wrap .check_box .el-checkbox__input.is-checked+.el-checkbox__label{
         color : #555555;
     }


   .SD11X5_wrap .check_box   .el-checkbox__input.is-checked{
         background: none;
     }
   .SD11X5_wrap .check_box  .el-checkbox__label{
        padding-left:5px;
    }

    .SD11X5_wrap .check_box  .el-checkbox__input.is-checked .el-checkbox__inner, .SD11X5_wrap .el-checkbox__input.is-indeterminate .el-checkbox__inner{
         background-color: #fff;
         border-color: #555555;
     }

     .SD11X5_wrap .el-checkbox__input.is-focus .el-checkbox__inner{
         border-color :  #555;
     }

    .SD11X5_wrap .el-checkbox__input{
        margin-top:-0.5px;
    }

    .SD11X5_wrap .el-checkbox{
        border-color: #666666;
     }

    .SD11X5_wrap .el-checkbox__inner{
         border : 1px solid #666666;
     }

    .SD11X5_wrap .el-checkbox__input.is-checked .el-checkbox__inner span::after{
        
     }

    .SD11X5_wrap .el-checkbox__inner::after{
        top:0px;
        left:3px;
    ...
    .SD11X5_cont_data_1 table{
        width:100%;
        border-collapse: collapse;
    }

    .SD11X5_cont_data_1 table tbody{
        width:100%;
    }

    .SD11X5_cont_data_1 table tr{
        width:100%;
        height:30px;
        display : flex;
    }
    .SD11X5_cont_data_1 table tr td{
        height:30px; 
        line-height:30px;
        flex:1;
        font-size:11px;
    ...
    .SD11X5_cont_data_1 table tr td:nth-child(2){
        color:red;
    }

     .SD11X5_cont_data_1 table tr td:nth-child(1), .SD11X5_cont_data_1 table tr td:nth-child(2){
          flex:2;
     }
     .SD11X5_cont_data_1 table tr td:nth-child(8), .SD11X5_cont_data_1 table tr td:nth-child(9){
         flex:1.2;
         font-size:11px;
     }
  ...
  .SD11X5_cont>div:nth-child(1){
        flex: 1.2;
    }

    .SD11X5_cont>div:last-child{
        border:none;
    }

    .SD11X5_cont_item .SD11X5_cont_head_1{
        height: 60px;
        line-height: 60px;
        background: #e8eced;
    ...
    .SD11X5_cont_item .SD11X5_cont_head_1>h4{
        flex: 2;
        text-align: center;
        letter-spacing: 2px;
        font-size: 12px;
    ...
    .SD11X5_cont_item .SD11X5_cont_head_1>h5{
         flex: 2;
         text-align:center;
         letter-spacing: 1px;
         font-size: 11.5px;
    ...
    .SD11X5_cont_item .SD11X5_cont_head_1>h6{
        flex: 1;
        font-size:11.5px;
        text-align: center;
    }

    .SD11X5_cont_item .SD11X5_cont_head_1 > h6:nth-child(8),.SD11X5_cont_item .SD11X5_cont_head_1 > h6:nth-child(9){
        flex:1.2;
    }
    ...
    .SD11X5_cont_head_2>div{
        display: flex;
        height:30px;
    }
    .SD11X5_cont_head_2>div>span{
        flex: 1;
        line-height: 30px;
        color:#515253;
        text-align: center;
    }
    .SD11X5_cont_head_2>div>span+span{
    ...
    .SD11X5_cont_data_1>ul{
        flex: 2;
    }
    .SD11X5_cont_data_1>ol{
        flex: 1;
    }
    .SD11X5_cont_data_1>ul:nth-child(2)>li{
        color : #ff0000;
    }
    .SD11X5_cont_data_1>ul>li, .SD11X5_cont_data_1>ol>li{
        height: 30px;
        line-height: 30px;
        text-align: center;
        font-size: 12px;
    ...
    .SD11X5_cont_data_1>ul>li:nth-child(odd), .SD11X5_cont_data_1>ol>li:nth-child(odd), .SD11X5_cont_data_1 table tr:nth-child(odd){
        background:#f3f2f2;;
    }
    .SD11X5_cont_data_1>ul>li:nth-child(even), .SD11X5_cont_data_1>ol>li:nth-child(even) , .SD11X5_cont_data_1 table tr:nth-child(even){
        background:#f3fdfb;
    }
   ...
   .SD11X5_cont_data_2{
    ...
    .SD11X5_cont_data_2 table{
        width:100%;
    }

   .SD11X5_cont_data_2 table tr{
       display: flex;
       height:30px;
       line-height:30px;
   }

   .SD11X5_cont_data_2 table tr:nth-child(odd){
       background:#f3f2f2;
   }
   .SD11X5_cont_data_2 table tr:nth-child(even){
       background:#f3fdfb;
   }

    .SD11X5_cont_data_2 table tr td{
        flex: 1;
         font-size: 11.5px;
         /* width:20px; */
         color: #aaa;
    ...
    .SD11X5_cont_data_2 table tr td+td{
        border-left: 0.5px solid #fff;
    }

    .SD11X5_cont_data_2 table tr td i{
    ...
    .SD11X5_footer>div+div{
        border-left:1px solid #ff0000;
    }
    .SD11X5_footer>div:nth-child(1){
        flex:1.2;
    }

    .SD11X5_footer>div:nth-child(1)>p{
        height:30px;
        line-height:30px;
        text-align:center;
    }
    .SD11X5_footer>div:nth-child(1)>p:nth-child(odd), .SD11X5_footer .SD11X5_footer_2 table tbody tr:nth-child(odd){
        background : #00ffff;
    }
    .SD11X5_footer>div:nth-child(1)>p:nth-child(even), .SD11X5_footer .SD11X5_footer_2 table tbody tr:nth-child(even){
         background : #f3f2f2;
    }
    ...
    .SD11X5_footer_2>ul>li:nth-child(odd){
        background : #00ffff;
    }
    .SD11X5_footer_2>ul>li:nth-child(even){
        background : #f3f2f2;
    }

    .SD11X5_footer_2>ul>li{
        height:30px;
        line-height:30px;
        text-align:center;
         font-size:11.5px;
