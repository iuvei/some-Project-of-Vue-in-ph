<template>
    <div class="JSLHC">
        <div class="JSLHC_wrap JSLHC_wrap_1">
            <h3>历史号码走势</h3>
            <div class="check_box">
        ...
        <div class="JSLHC_wrap JSLHC_wrap_2" v-show="is_show_data_1">
            <div class="JSLHC_cont" >
                <div class="JSLHC_cont_item" v-show="is_start_tab[0]" style="padding-bottom:150px;">
                     <div class="JSLHC_cont_head_1" v-if="start_list_box.length > 1">
                ...
                <div class="JSLHC_cont_item" v-show="is_start_tab[arr_indexs]" v-for="(arr_items,arr_indexs) in arr_data_list.stat" :key="arr_indexs">
                    <div class="JSLHC_cont_head_2">
                    ...
                    <div class="JSLHC_cont_data_2" :class="'canvas_wrap_' + (arr_indexs-1)">
                        <table>
                            <tbody>
                                <tr v-for="(items, indexs) in trans_late_arr[arr_indexs-1]" :key="indexs">
                                    <td style="flex:2;color:#666;" > {{ arr_data_list.list[indexs].IssueNumber | slic }} </td>
                    ...
                    <div class="JSLHC_footer" v-show=" is_start_tab[arr_indexs]">
                        <div class="JSLHC_footer_1" >
                            <p>总共出现</p>
                            <p>最大连出</p>
                            <p>最大遗漏</p>
                            <p>平均遗漏</p>
                        ...
                        <div class="JSLHC_footer_2" v-for="(items,indexs) in arr_data_list.stat" :key="indexs"   v-show=" is_start_tab[indexs]">
...
<style >
  ...
  .JSLHC_wrap .check_box .el-checkbox__input.is-checked+.el-checkbox__label{
         color : #555555;
     }


   .JSLHC_wrap .check_box   .el-checkbox__input.is-checked{
         background: none;
     }
   .JSLHC_wrap .check_box  .el-checkbox__label{
        padding-left:5px;
    }

    .JSLHC_wrap .check_box  .el-checkbox__input.is-checked .el-checkbox__inner, .JSLHC_wrap .el-checkbox__input.is-indeterminate .el-checkbox__inner{
         background-color: #fff;
         border-color: #555555;
     }

     .JSLHC_wrap .el-checkbox__input.is-focus .el-checkbox__inner{
         border-color :  #555;
     }

    .JSLHC_wrap .el-checkbox__input{
        margin-top:-0.5px;
    }

    .JSLHC_wrap .el-checkbox{
        border-color: #666666;
     }

    .JSLHC_wrap .el-checkbox__inner{
         border : 1px solid #666666;
     }

    .JSLHC_wrap .el-checkbox__input.is-checked .el-checkbox__inner span::after{
        
     }

    .JSLHC_wrap .el-checkbox__inner::after{
        top:0px;
        left:3px;
    ...
    .JSLHC_cont_data_1 table{
        width:100%;
        border-collapse: collapse;
    }

    .JSLHC_cont_data_1 table tbody{
        width:100%;
    }

    .JSLHC_cont_data_1 table tr{
        width:100%;
        height:30px;
        display : flex;
    }
    .JSLHC_cont_data_1 table tr td{
        height:30px; 
        line-height:30px;
        flex:1;
        font-size:11px;
    ...
    .JSLHC_cont_data_1 table tr td:nth-child(2){
        /* color:red; */
    }

     .JSLHC_cont_data_1 table tr td:nth-child(1), .JSLHC_cont_data_1 table tr td:nth-child(2){
          flex:2;
     }
     .JSLHC_cont_data_1 table tr td:nth-child(8), .JSLHC_cont_data_1 table tr td:nth-child(9){
         flex:1;
         font-size:11px;
     }
   ...
   .JSLHC_cont>div:nth-child(1){
        flex: 1.5;
    }

    .JSLHC_cont>div:last-child{
        border:none;
    }

    .JSLHC_cont_item .JSLHC_cont_head_1{
        height: 60px;
        line-height: 60px;
        background: #e8eced;
    ...
    .JSLHC_cont_item .JSLHC_cont_head_1>h4{
        flex: 2;
        text-align: center;
        letter-spacing: 2px;
        font-size: 12px;
    ...
    .JSLHC_cont_item .JSLHC_cont_head_1>h5{
         flex: 2;
         text-align:center;
         letter-spacing: 1px;
         font-size: 11.5px;
    ...
    .JSLHC_cont_item .JSLHC_cont_head_1>h6{
        flex: 1;
        font-size:11.5px;
        text-align: center;
    }

    .JSLHC_cont_item .JSLHC_cont_head_1 > h6:nth-child(8),.JSLHC_cont_item .JSLHC_cont_head_1 > h6:nth-child(9){
        flex:1;
    }
    ...
    .JSLHC_cont_head_2>div{
        display: flex;
        height:30px;
    }
    .JSLHC_cont_head_2>div>span{
        flex: 1;
        line-height: 30px;
        color:#515253;
        text-align: center;
    }
    .JSLHC_cont_head_2>div>span+span{
    ...
    .JSLHC_cont_data_1>ul{
        flex: 2;
    }
    .JSLHC_cont_data_1>ol{
        flex: 1;
    }
    .JSLHC_cont_data_1>ul:nth-child(2)>li{
        /* color : #ff0000; */
    }
    .JSLHC_cont_data_1>ul>li, .JSLHC_cont_data_1>ol>li{
        height: 30px;
        line-height: 30px;
        text-align: center;
        font-size: 12px;
    ...
    .JSLHC_cont_data_1>ul>li:nth-child(odd), .JSLHC_cont_data_1>ol>li:nth-child(odd), .JSLHC_cont_data_1 table tr:nth-child(odd){
        background:#f3f2f2;;
    }
    .JSLHC_cont_data_1>ul>li:nth-child(even), .JSLHC_cont_data_1>ol>li:nth-child(even) , .JSLHC_cont_data_1 table tr:nth-child(even){
        background:#f3fdfb;
    }
   ...
   .JSLHC_cont_data_2{
    ...
    .JSLHC_cont_data_2 table{
        width:100.15%;
    }

   .JSLHC_cont_data_2 table tr{
       display: flex;
       height:30px;
       line-height:30px;
   }

   .JSLHC_cont_data_2 table tr:nth-child(odd){
       background:#f3f2f2;
   }
   .JSLHC_cont_data_2 table tr:nth-child(even){
       background:#f3fdfb;
   }

    .JSLHC_cont_data_2 table tr td{
        flex: 1;
         font-size: 12px;
         color: #aaa;
         position: relative;
    ...
    .JSLHC_cont_data_2 table tr td+td{
        border-left: 0.5px solid #fff;
    }

    .JSLHC_cont_data_2 table tr td i{
    ...
    .JSLHC_footer>div+div{
        /* border-left:1px solid #ff0000; */
    }
    .JSLHC_footer>div:nth-child(1){
        flex:2;
    }

    .JSLHC_footer>div:nth-child(1)>p{
        height:30px;
        line-height:30px;
        text-align:center;
    }
    .JSLHC_footer>div:nth-child(1)>p:nth-child(odd), .JSLHC_footer .JSLHC_footer_2 table tbody tr:nth-child(odd){
        background : #00ffff;
    }
    .JSLHC_footer>div:nth-child(1)>p:nth-child(even), .JSLHC_footer .JSLHC_footer_2 table tbody tr:nth-child(even){
         background : #f3f2f2;
    }
    ...
    .JSLHC_footer_2>ul>li:nth-child(odd){
        background : #00ffff;
    }
    .JSLHC_footer_2>ul>li:nth-child(even){
        background : #f3f2f2;
    }

    .JSLHC_footer_2>ul>li{
        height:30px;
        line-height:30px;
        text-align:center;
         font-size:11.5px;
   ...
   .JSLHC .JSLHC_wrap .JSLHC_cont .JSLHC_cont_head_1 h4, .JSLHC .JSLHC_wrap .JSLHC_cont .JSLHC_cont_head_1 h5, .JSLHC .JSLHC_wrap .JSLHC_cont .JSLHC_cont_head_1 h6 , .JSLHC .JSLHC_wrap .JSLHC_cont  .JSLHC_cont_data_1 tr td{
        font-size: 13px;
    }
</style>