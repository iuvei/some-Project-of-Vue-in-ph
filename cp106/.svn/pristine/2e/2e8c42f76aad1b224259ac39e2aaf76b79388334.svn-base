import Vue from 'vue'
import ks1 from '../image/ks@1.png'
import ks2 from '../image/ks@2.png'
import ks3 from '../image/ks@3.png'
import ks4 from '../image/ks@4.png'
import ks5 from '../image/ks@5.png'
import ks6 from '../image/ks@6.png'

Vue.filter('ksFilter', val => {
  let img=''
  if (val==1) {
    img = ks1
  } else if (val==2) {
