<template>
    <div class="GXKS">
        <div class="GXKS_wrap GXKS_wrap_1">
            <h3>历史号码走势</h3>
        ...
        <div class="GXKS_wrap GXKS_wrap_2" v-show="is_show_data_1">
            <div class="GXKS_cont" >
                <div class="GXKS_cont_item">
                     <div class="GXKS_cont_head_1" v-if="start_list_box.length > 1">
                        <!-- <h4>期数</h4>
                        <h5>开奖号码</h5>
                ...
                <div class="GXKS_cont_item" v-for="(arr_items,arr_indexs) in arr_data_list.stat" :key="arr_indexs">
                    <div class="GXKS_cont_head_2">
                    ...
                    <div class="GXKS_cont_data_2" :class="'canvas_wrap_' + (arr_indexs-1)">
                        <table>
                            <tbody>
            ...
            <div class="GXKS_footer">
                <div class="GXKS_footer_1">
                    <p>总共出现</p>
                    <p>最大连出</p>
                    <p>最大遗漏</p>
                    <p>平均遗漏</p>
                ...
                <div class="GXKS_footer_2" v-for="(items,indexs) in arr_data_list.stat" :key="indexs" >
                    <!-- <table>
                        <tbody>
...
<style >
  ...
  .GXKS_wrap .check_box .el-checkbox__input.is-checked+.el-checkbox__label{
         color : #555555;
     }


   .GXKS_wrap .check_box   .el-checkbox__input.is-checked{
         background: none;
     }
   .GXKS_wrap .check_box  .el-checkbox__label{
        padding-left:5px;
    }

    .GXKS_wrap .check_box  .el-checkbox__input.is-checked .el-checkbox__inner, .GXKS_wrap .el-checkbox__input.is-indeterminate .el-checkbox__inner{
         background-color: #fff;
         border-color: #555555;
     }

     .GXKS_wrap .el-checkbox__input.is-focus .el-checkbox__inner{
         border-color :  #555;
     }

    .GXKS_wrap .el-checkbox__input{
        margin-top:-0.5px;
    }

    .GXKS_wrap .el-checkbox{
        border-color: #666666;
     }

    .GXKS_wrap .el-checkbox__inner{
         border : 1px solid #666666;
     }

    .GXKS_wrap .el-checkbox__input.is-checked .el-checkbox__inner span::after{
        
     }

    .GXKS_wrap .el-checkbox__inner::after{
        top:0px;
        left:3px;
    ...
    .GXKS_cont_data_1 table{
        width:100%;
        border-collapse: collapse;
    }

    .GXKS_cont_data_1 table tbody{
        width:100%;
    }

    .GXKS_cont_data_1 table tr{
        width:100%;
        height:30px;
        display : flex;
    }
    .GXKS_cont_data_1 table tr td{
        height:30px; 
        line-height:30px;
        flex:1;
        font-size:11px;
    ...
    .GXKS_cont_data_1 table tr td:nth-child(2){
        color:red;
    }

     .GXKS_cont_data_1 table tr td:nth-child(1), .GXKS_cont_data_1 table tr td:nth-child(2){
          flex:2;
     }
     .GXKS_cont_data_1 table tr td:nth-child(8), .GXKS_cont_data_1 table tr td:nth-child(9){
         flex:1;
         font-size:11px;
     }
 ...
 .GXKS_cont>div:nth-child(1){
        flex: 1.5;
    }

    .GXKS_cont>div:last-child{
        border:none;
    }

    .GXKS_cont_item .GXKS_cont_head_1{
        height: 60px;
        line-height: 60px;
        background: #e8eced;
    ...
    .GXKS_cont_item .GXKS_cont_head_1>h4{
        flex: 2;
        text-align: center;
        letter-spacing: 2px;
        font-size: 12px;
    ...
    .GXKS_cont_item .GXKS_cont_head_1>h5{
         flex: 2;
         text-align:center;
         letter-spacing: 1px;
         font-size: 11.5px;
    ...
    .GXKS_cont_item .GXKS_cont_head_1>h6{
        flex: 1;
        font-size:11.5px;
        text-align: center;
    }

    .GXKS_cont_item .GXKS_cont_head_1 > h6:nth-child(8),.GXKS_cont_item .GXKS_cont_head_1 > h6:nth-child(9){
        flex:1;
    }
    ...
    .GXKS_cont_head_2>div{
        display: flex;
        height:30px;
    }
    .GXKS_cont_head_2>div>span{
        flex: 1;
        line-height: 30px;
        color:#515253;
        text-align: center;
    }
    .GXKS_cont_head_2>div>span+span{
    ...
    .GXKS_cont_data_1>ul:nth-child(2)>li{
        color : #ff0000;
    }
    .GXKS_cont_data_1>ul>li, .GXKS_cont_data_1>ol>li{
        height: 30px;
        line-height: 30px;
        text-align: center;
        font-size: 12px;
    ...
    .GXKS_cont_data_1>ul>li:nth-child(odd), .GXKS_cont_data_1>ol>li:nth-child(odd), .GXKS_cont_data_1 table tr:nth-child(odd){
        background:#f3f2f2;;
    }
    .GXKS_cont_data_1>ul>li:nth-child(even), .GXKS_cont_data_1>ol>li:nth-child(even) , .GXKS_cont_data_1 table tr:nth-child(even){
        background:#f3fdfb;
    }
   ...
   .GXKS_cont_data_2{
    ...
    .GXKS_cont_data_2 table{
        width:100%;
    }

   .GXKS_cont_data_2 table tr{
       display: flex;
       height:30px;
       line-height:30px;
   }

   .GXKS_cont_data_2 table tr:nth-child(odd){
       background:#f3f2f2;
   }
   .GXKS_cont_data_2 table tr:nth-child(even){
       background:#f3fdfb;
   }

    .GXKS_cont_data_2 table tr td{
        flex: 1;
         font-size: 12px;
         color: #aaa;
         position: relative;
    ...
    .GXKS_cont_data_2 table tr td+td{
        border-left: 0.5px solid #fff;
    }

    .GXKS_cont_data_2 table tr td i{
    ...
    .GXKS_footer>div:nth-child(1){
        flex:1.5;
    }

    .GXKS_footer>div:nth-child(1)>p{
        height:30px;
        line-height:30px;
        text-align:center;
    }
    .GXKS_footer>div:nth-child(1)>p:nth-child(odd), .GXKS_footer .GXKS_footer_2 table tbody tr:nth-child(odd){
        background : #00ffff;
    }
    .GXKS_footer>div:nth-child(1)>p:nth-child(even), .GXKS_footer .GXKS_footer_2 table tbody tr:nth-child(even){
         background : #f3f2f2;
    }
    ...
    .GXKS_footer_2>ul>li:nth-child(odd){
        background : #00ffff;
    }
    .GXKS_footer_2>ul>li:nth-child(even){
        background : #f3f2f2;
    }
